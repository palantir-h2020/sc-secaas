...
class IDSCharm(CharmBase):
    ...
    def _on_start_service_action(self, event):
        ...
        try:
            ...
            event.fail(f"Stop: IDS service stopped failed with the following exception: {e}")
    ...
    def _on_start_configuration_action(self, event):
        ...
        try:
            ...
            event.fail(f"Start-configuration: IDS service configuration failed with the following exception: {e}")
